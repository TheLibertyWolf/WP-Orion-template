...
[![Version](https://img.shields.io/badge/version-3.6.1-2271b1)](https://github.com/TheLibertyWolf/WP-Orion-template/releases)
...
1. Télécharger `orion-26-3.6.1.zip` depuis la [dernière release](https://github.com/TheLibertyWolf/WP-Orion-template/releases/latest).
